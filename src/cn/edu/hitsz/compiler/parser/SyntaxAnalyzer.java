...
public class SyntaxAnalyzer {
    ...
    public void run() {
        ...
        for (int position = 0; position < tokenList.size();) {
            Status currentStatus = statusStack.peek();
            Token currentToken = tokenList.get(position);
            ...
            switch (currentAction.getKind()) {
                ...
                case Reduce -> {
                    Production production = currentAction.getProduction();
                    ...
                    symbolStack.push(new Symbol(nonTerminal));
                }
